...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Nkanyezi Solar Solutions",
    phone:     "+27 76 321 5254",
    whatsapp:  "+27 76 321 5254",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Nkanyezi Solar Solutions — Solar installation in randburg",
    description: "Nkanyezi Solar Solutions provides professional solar installation in Randburg. 9 Google reviews. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "Nkanyezi Solar Solutions designs and installs solar panel systems, battery backup and inverter solutions for homes and businesses across Randburg. Load-shedding proof your property.",
    ...
    band: {
      ...
      alt:   "Nkanyezi Solar Solutions team at work in Randburg",
